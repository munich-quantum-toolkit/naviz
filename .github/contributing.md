...
Ready to contribute? Check out the {doc}`Development Guide <DevelopmentGuide>` to set up MQT NAViz for local development and learn about the style guidelines and conventions used throughout the project.
...
- Follow the branch naming `<type>/<issue-number>-<short-description>`.
